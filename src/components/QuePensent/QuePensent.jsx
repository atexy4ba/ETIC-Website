...
const QuePensent = () => {
  const testimonials = [
    ...
    {
      text: "The team was incredibly responsive and helpful throughout the project. Their attention to detail and willingness to iterate on our feedback was greatly appreciated.",
      author: "John Doe",
      role: "Respo Comm",
    },
    {
      text: "Working with this team was a pleasure. They brought a high level of expertise and professionalism to the project, and the end result exceeded our expectations.",
      author: "Jane Smith",
      role: "Respo Local",
    },
    {
