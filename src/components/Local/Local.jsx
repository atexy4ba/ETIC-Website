...
const Local = () => {
  return (
    <div className="font-satoshi bg-[#141516] flex lg:flex-row flex-col items-center lg:items-start text-center lg:text-left p-10 md:p-12 lg:p-16 text-white w-5/6 self-center rounded-xl gap-10">
