...
const FAQ = () => {
  ...
  return (
    <div className="flex flex-col gap-10 px-5 md:px-24 md:pt-12 pt-8" id="faq">
      <TitreSection
        h1={"On répond"}
        ...
        color={"#20B3AD"}
      />
      <div className="flex flex-col gap-6 rounded-lg text-left">
        <Accordion
        ...
        Weve worked hard to gather the robust datasets and quality knowledge required to support the creation and use of everyday technology by speakers."
